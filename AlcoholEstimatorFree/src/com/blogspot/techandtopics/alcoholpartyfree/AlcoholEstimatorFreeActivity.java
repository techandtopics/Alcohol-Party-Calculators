...
import com.blogspot.techandtopics.alcoholpartyfree.R;
 ...
 * 
 */
public class AlcoholEstimatorFreeActivity extends Activity{
	...
	public void startCostActivity(View v) {
		Intent costIntent = new Intent(this, CostFreeActivity.class);
	...
	public void startPartyActivity(View v) {
		Intent partyIntent = new Intent(this, PartyFreeActivity.class);
